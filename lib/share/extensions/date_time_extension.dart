...
extension DateTimeExt on DateTime {
  ...
  String get formatDateMMMMddYYY =>
      DateFormat(dateFormatMMMMddYYY).format(this);
  ...
  String get formatDateddMMMyyyy =>
      DateFormat(dateFormatddMMMyyyy).format(this);

  String get formatDateE => DateFormat(dateFormatE).format(this);

  String get formatDateEMMMMDDYYYY =>
      DateFormat(dateFormatEMMMMDDYYYY).format(this);

  String get formatDateMMMM => DateFormat(dateFormatMMMM).format(this);

  String get formatDateddMMMyyyyHHmmaa =>
      DateFormat(dateFormatddMMMyyyyHHmma).format(this);
